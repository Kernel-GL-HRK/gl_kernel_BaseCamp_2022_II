			  ...
			  size_t count, loff_t *offset)
{
	...
	pr_debug("HELLO: PROC: DEBUG: count(read) = %d\n", count);
	pr_debug("HELLO: PROC: DEBUG: delta(read) = %d\n", delta);
	pr_debug("HELLO: PROC: DEBUG: procfs_buffer_size(read) = %d\n",
		 procfs_buffer_size);
			   ...
			   size_t count, loff_t *offset)
{
	...
	procfs_buffer_size = delta;
	pr_debug("HELLO: PROC: DEBUG: procfs_buffer_size(write) = %d\n",
		 procfs_buffer_size);
