...
//int _spi_init(struct spi_device *spi);
void _spi_exit(struct spi_device *spi);
...
void fillRec(uint8_t x, uint8_t y, uint8_t w, uint8_t h, uint16_t color, struct spi_device *spi);
